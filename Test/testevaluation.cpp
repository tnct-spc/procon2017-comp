...
//    frames.push_back ( nep );
    ...
    vector = (new Evaluation) -> evaluation(frames.at(0) , polygons.at(0));

    int field_index,polygon_index,evaluation;
    mytuple(evaluation , field_index , polygon_index) = vector.at(0);
